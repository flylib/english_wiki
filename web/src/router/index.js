    ...
    children: [
      {
        path: '/wiki',
        name: 'wiki-reader',
        component: () => import('../views/wiki/reader/index.vue'),
        meta: {
          title: '英语百科',
        },
      },
      {
        path: '/admin/entry',
        name: 'wiki-admin-entry',
        component: () => import('../views/wiki/admin/entry.vue'),
        meta: {
          title: '条目管理',
        },
      },
      {
        path: '/admin/category',
        name: 'wiki-admin-category',
        component: () => import('../views/wiki/admin/category.vue'),
        meta: {
          title: '分类管理',
        },
      },
